//1、天书版9.0重构版，此版完全抛弃原始管道流传输方式，传输稳定性更好一些，给大家多一个选择，建议pages部署
...
//////////////////////////////////////////////////////////////////////////配置区块////////////////////////////////////////////////////////////////////////
let 哎呀呀这是我的ID啊 = "123321"; //实际上这是你的订阅路径，支持任意大小写字母和数字，[域名/ID]进入订阅页面
let 哎呀呀这是我的VL密钥 = "a581d94c-5eca-4a52-90f5-97de60339203"; //这是真实的UUID，通用订阅会进行验证，建议修改为自己的规范化UUID
...
let 我的SOCKS5账号 = 'b5ab79a6d72031184e51:0080491821@allidns.cc:56115' //格式'账号:密码@地址:端口'

let 我的节点名字 = 'DLJ' //自己的节点名字【统一名称】
...
export default {
  async fetch(访问请求, env) {
    ...
    if (!读取我的请求标头 || 读取我的请求标头 !== 'websocket') {
      ...
      switch (true) {
        case url.searchParams.has('proxyip'):
          反代IP = url.searchParams.get('proxyip') || env.PROXYIP || 反代IP;
          break;
        case url.searchParams.has('socks5'):
          我的SOCKS5账号 = url.searchParams.get('socks5') || env.SOCKS5 || 我的SOCKS5账号;
          break;
      }
